...
namespace Player_Control
{
    ...
    public sealed class PlayerControl : MonoBehaviour
    {
        ...
        private void Start()
        {
            playerControlSettings.InitializationParameters(speedMove, speedRotate, speedZoom,
    ...
    public struct PlayerControlSettings
    {
        ...
        public void InitializationParameters(in float speedMove, in float speedRotate,
