...
namespace Player_Control
{
    public sealed class ControlLocation : IControl
    {
        ...
        public void Rotate()
        {
            Vector3 directionRotate = new Vector3(0f, InputControl.AxisRotate, 0f) * PlayerControl.PlayerControlSettings.SpeedMove;

            PlayerControl.PlayerControlSettings.MainPlayerObject.RotateAround(RaycastZoomPath.RaycastSettings.RayHit.point, directionRotate, 1f);
